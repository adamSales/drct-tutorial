...
```{r}
#subset to specific variable names for Shiny app demo 
subset_var_names <- read.csv("../input/subset_var_names.csv", col.names = "col_name")

aux_dat_small <- aux_dat %>%
  select(subset_var_names$col_name)

write.csv(aux_dat_small, "../data/aux_dat_small.csv", row.names = FALSE)
```
